    ...
    <div class="w-full">
      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center border border-gray-300 w-max roundedfull">
          <button
            class="cursor-pointer py-1 pl-4 pr-2 text-lg flex itemscenter justify-center"
          >
            -
          </button>
          <div class="py-1 px-2 text-lg flex items-center justifycenter">1</div>
          <button
            class="cursor-pointer py-1 pl-2 pr-4 text-lg flex itemscenter justify-center"
          >
            +
          </button>
        </div>
        <div
          class="flex items-center gap-2 border border-gray-300 px-3 py-2 roundedfull cursor-pointer"
